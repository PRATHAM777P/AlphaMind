...
import { FINANCIAL_SEARCH_DESCRIPTION, FINANCIAL_METRICS_DESCRIPTION, WEB_SEARCH_DESCRIPTION, WEB_FETCH_DESCRIPTION, READ_FILINGS_DESCRIPTION, BROWSER_DESCRIPTION, OPENBB_EQUITY_DESCRIPTION, OPENBB_ECONOMY_DESCRIPTION, OPENBB_SCREENER_DESCRIPTION, OPENBB_NEWS_DESCRIPTION } from './descriptions/index.js';
import { openbbEquityTool, openbbEconomyTool, openbbScreenerTool, openbbNewsTool } from './openbb/index.js';
...
export function getToolRegistry(model: string): RegisteredTool[] {
  ...
  // Include OpenBB tools if API URL is configured
  if (process.env.OPENBB_API_URL) {
    tools.push(
      {
        name: 'openbb_equity',
        tool: openbbEquityTool,
        description: OPENBB_EQUITY_DESCRIPTION,
      },
      {
        name: 'openbb_economy',
        tool: openbbEconomyTool,
        description: OPENBB_ECONOMY_DESCRIPTION,
      },
      {
        name: 'openbb_screener',
        tool: openbbScreenerTool,
        description: OPENBB_SCREENER_DESCRIPTION,
      },
      {
        name: 'openbb_news',
        tool: openbbNewsTool,
        description: OPENBB_NEWS_DESCRIPTION,
      }
    );
  }
